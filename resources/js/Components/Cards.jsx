export default function Cards() {
    return (
        <>
            <div class="m-7 relative flex bg-clip-border rounded-xl bg-white text-gray-700 shadow-md w-full max-w-[48rem] flex-row">
                <div
                ...
                <div class="p-6 bg-gray-200">
                    <h6
                        ...
                        Discover More Flights
                    </h6>
                    <h4 class="block mb-2 font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
                        Flights this week, depending on people's experience
                    </h4>
                    <p class="block mb-8 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
                        Discover more flights near you, or in your needs
                    </p>
